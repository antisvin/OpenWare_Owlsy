...
all: alchemist wizard magus witch lich owlpedal midiboot noctua daisypatch midibootdaisy # biosignals tesseract prism effectsbox player quadfm  ## build most targets
