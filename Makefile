...
.PHONY: alchemist wizard magus lich owlpedal quadfm player prism effectsbox noctua biosignals witch midiboot tesseract

export OPENWARE CONFIG

all: alchemist wizard magus lich witch owlpedal midiboot noctua effectsbox biosignals daisypatch # tesseract prism player quadfm  ## build most targets
