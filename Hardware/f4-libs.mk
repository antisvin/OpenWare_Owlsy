...
# required by OWL 2
C_SRC_SAI = $(DRIVERS)/Src/stm32f4xx_hal_sai.c
C_SRC_SAI += $(DRIVERS)/Src/stm32f4xx_hal_sai_ex.c
...
C_SRC_I2S += $(DRIVERS)/Src/stm32f4xx_hal_i2c.c
C_SRC_I2S += $(DRIVERS)/Src/stm32f4xx_hal_i2c_ex.c
