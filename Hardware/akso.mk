...
LDSCRIPT ?= $(OPENWARE)/Hardware/akso.ld
LDLIBS += -lc -lm
...
CFLAGS  += -std=gnu99
ARCH_FLAGS = -mcpu=cortex-m7 -mfloat-abi=hard -mfpu=fpv5-sp-d16 -mthumb
ARCH_FLAGS += -fsingle-precision-constant
DEF_FLAGS = -DSTM32H43xx -DARM_MATH_CM7
DEF_FLAGS += -D__FPU_PRESENT=1
S_SRC ?= $(BUILDROOT)/Src/bootrom_stm32h743xx.s
