...
OBJS += $(DRIVERS)/Src/stm32h7xx_hal.o
OBJS += $(DRIVERS)/Src/stm32h7xx_hal_rcc.o
OBJS += $(DRIVERS)/Src/stm32h7xx_hal_dma.o
OBJS += $(DRIVERS)/Src/stm32h7xx_hal_adc.o
OBJS += $(DRIVERS)/Src/stm32h7xx_hal_gpio.o
OBJS += $(DRIVERS)/Src/stm32h7xx_hal_adc_ex.o
OBJS += $(DRIVERS)/Src/stm32h7xx_hal_dma_ex.o
OBJS += $(DRIVERS)/Src/stm32h7xx_hal_pwr_ex.o
OBJS += $(DRIVERS)/Src/stm32h7xx_hal_rcc_ex.o
OBJS += $(DRIVERS)/Src/stm32h7xx_hal_flash.o
OBJS += $(DRIVERS)/Src/stm32h7xx_hal_flash_ex.o
OBJS += $(DRIVERS)/Src/stm32h7xx_hal_tim_ex.o
...
OBJS_RTC = $(DRIVERS)/Src/stm32h7xx_hal_rtc.o
OBJS_RTC += $(DRIVERS)/Src/stm32h7xx_hal_pwr.o
OBJS_RTC += $(DRIVERS)/Src/stm32h7xx_hal_rtc_ex.o
OBJS_IWDG = $(DRIVERS)/Src/stm32h7xx_hal_iwdg.o

# external SDRAM
OBJS_SDRAM = $(DRIVERS)/Src/stm32h7xx_hal_sdram.o
OBJS_SDRAM += $(DRIVERS)/Src/stm32h7xx_ll_fmc.o
...
OBJS_USBD += $(DRIVERS)/Src/stm32h7xx_hal_pcd_ex.o
OBJS_USBD += $(DRIVERS)/Src/stm32h7xx_ll_usb.o
...
### USB Host Library ###
OBJS_USBH = $(DRIVERS)/Src/stm32h7xx_hal_hcd.o
