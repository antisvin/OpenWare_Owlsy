...
uint8_t getPortMode(uint8_t index) { return 0; }
}
...
//    TIM1->CCR2 = tft_bl < 10 ? 10 : tft_bl;
  ...
  /*
    HAL_GPIO_WritePin(OLED_RST_GPIO_Port, OLED_RST_Pin, GPIO_PIN_RESET); // OLED
    off extern SPI_HandleTypeDef OLED_SPI; graphics.begin(&OLED_SPI);
