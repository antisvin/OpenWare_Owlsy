...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, LED1_R_Pin, GPIO_PIN_SET);
  HAL_GPIO_WritePin(GPIOC, USER_LED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, LED2_G_Pin|LED2_B_Pin|LED1_G_Pin|LED1_B_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED2_R_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : USER_LED_Pin LED1_R_Pin */
  GPIO_InitStruct.Pin = USER_LED_Pin|LED1_R_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : LED2_G_Pin LED2_B_Pin LED1_G_Pin LED1_B_Pin */
  GPIO_InitStruct.Pin = LED2_G_Pin|LED2_B_Pin|LED1_G_Pin|LED1_B_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : LED2_R_Pin CODEC_RESET1_Pin */
